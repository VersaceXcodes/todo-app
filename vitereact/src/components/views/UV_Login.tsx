...
const UV_Login: React.FC = () => {
  ...
  // Critical: Use individual selectors to prevent infinite render loops
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <Link to="/password-recovery" className="text-blue-600 hover:text-blue-500 text-sm font-medium">
                Forgot Password?
              </Link>
            </div>
          </form>
